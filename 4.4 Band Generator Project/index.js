...
app.post("/submit", (req, res) => {
  ...
  let randomNumb1 = Math.floor(Math.random()* adj.length);
  let randomNumb2 = Math.floor(Math.random()* noun.length);

  let randomBandName = adj[randomNumb1] + noun[randomNumb2];
